...
Segundo \citeonline{Carsten2012Collinearity}, colinearidade também é chamada de multicolinearidade. No entanto, de acordo com \citeonline{kim2019multicollinearity}, colinearidade refere-se ao caso em que uma variável apresenta forte relação linear com outra, enquanto multicolinearidade ocorre quando uma variável apresenta forte relação linear com duas ou mais variáveis.
